...
The ICF funded this application specific use of the Cosmos SDK for two reasons; first, we felt this team had a strong mission and second, their application development efforts helped improve general infrastructure for the SDK and Tendermint. They are early users of the SDK and provide consistent, useful feedback, have driven the development of a [major feature](https://github.com/cosmos/cosmos-sdk/pull/3979) and have fixed a number of [bugs](https://github.com/cosmos/cosmos-sdk/pull/3982) in the SDK. Their upstream changes to Cosmos SDK have ultimately benefited the entire community.
...
The ICF made a strategic investment in Agoric. The funds will be used to help further grow and develop the Agoric team.
...
The Agoric team is comprised of pioneers at the intersection of markets and computation; they were some of the first to discover that secure, executable contracts form the foundation of open, decentralized network infrastructure. They invented the first object-capabilities based security systems and have been evolving them at places like Microsoft and Google ever since. The design of the Cosmos-SDK and of IBC are both heavily influenced by their work. They have recently turned their attention to Javascript.
 ...
 A service agreement is also in place  for the team to develop specific milestones and work with All In Bits Inc and the ICF to merge Agoric Vat/CapTP and Cosmos IBC into a single protocol and build a smart contract execution environment that uses secure javascript and also natively can handle cross chain interaction. 
...
Confio was contracted by the ICF to build a generic protobuf format for IBC to encode merkle proofs from a range of data stores. The proofs used to describe the state of one blockchain to another in IBC are merkle proofs and signatures from validators.  The format that Confio is building  will allow IBC to be general in order to be able to describe many different types of merkle trees; Tendermint’s IAVL+ tree, Nomic’s AVL tree, and Ethereum’s Patricia tree. 
...
As promising new Proof-of-Stake networks launch, securities and tax regulators have not issued guidance around how these technologies will be regulated. The goal of the Proof of Stake Alliance (POSA) is to engage and educate regulators on the benefits of PoS technologies to help guide the new regulatory environment and ensure it accurately reflects the nature of the system. The ICF believes that POSA will play an important role in helping shape the conversations and regulations around PoS networks. We support these educational efforts, as they will benefit the entire PoS community and set an example for countries around the world looking for regulatory guidance on PoS. 
